...
import EditLabPatient from '../editLabPatient/EditLabPatient';
...
export default function LabList() {
    ...
    useEffect(() => {
        ...
        axios.get('http://localhost:8000/patient/viewAllPatientsBylab').then(
            patientData => {
          ...
          { (!loading) ? (
              tableData.map((row) => (
                ...
                >
                  ...
                  <TableCell align="right"><EditLabPatient patientId={row._id} /></TableCell>
